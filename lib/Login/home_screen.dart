...
import 'package:hiring/Login/login_methods.dart';
          ...
          child: Align(
            ...
            child: Column(
              ...
              children: [
                ...
                Visibility(
                  visible: Loading.widgetVisible.value == true,
                  child: Container(
                    height: Constant.height / 6,
                    width: Constant.width / 1.5,
                    child: TextFormField(
                ...
                Container(
                  ...
                  child: OutlinedButton.icon(
                      onPressed: () {
                        ...
                        Loading.widgetVisible.value = true;
                      },
                      icon: const Icon(CarbonIcons.checkbox_checked_filled),
                      label: !Loading.widgetVisible.value
                          ? Text("Send")
                          : Text("Verify")),
                ), //OTPWidget

                // !Loading.isClicked.value
                //     ? Container(
                //         height: Constant.height / 16,
                //         width: Constant.width / 3,
                //         child: OutlinedButton.icon(
                ...
                //             },
                //             icon:
                //                 const Icon(CarbonIcons.checkbox_checked_filled),
